...
<head>
    ...
    <style>
        /* Tinh chỉnh riêng cho trang Home để khớp Wireframe */
        .video-title a {
            color: var(--cli-dark);
            transition: color 0.2s;
        }
        .video-title a:hover {
            color: var(--cli-primary); /* Hover ra màu vàng thương hiệu */
            text-decoration: none;
        }

        /* Pagination style khớp màu */
        .pagination .page-link {
            color: var(--cli-dark);
            border-color: #dee2e6;
        }
        .pagination .page-item.active .page-link {
            background-color: var(--cli-dark);
            border-color: var(--cli-dark);
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card movie-card h-100 shadow-sm">
                    ...
                    <div class="card-footer card-footer-custom bg-white d-flex justify-content-between align-items-center py-3">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm px-4 rounded-pill shadow-sm"
                                data-bs-toggle="modal" data-bs-target="#shareModal" onclick="setShareId('${item.id}')">
        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-cli-dark text-white">
                <h5 class="modal-title fw-bold">
                    <i class="bi bi-envelope-paper-heart text-cli-primary"></i> Gửi video cho bạn bè
                </h5>
            ...
            <form action="<c:url value='/video/share'/>" method="post">
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Chúng tôi sẽ gửi link video này tới bạn của bạn.</div>
                    </div>
                </div>
                <div class="modal-footer border-top-0">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Hủy</button>
                    <button type="submit" class="btn btn-cli-primary px-4">Gửi ngay</button>
                </div>
            </form>
        </div>
    </div>
